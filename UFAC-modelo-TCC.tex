...
% Metodologia qualquer em ordem: ver Figura 2.

% \begin{figure}[!ht]
%     \centering
%     \textbf{\caption{Metodologia qualquer em ordem}}
%     \includesvg[width=1\linewidth]{figuras/exemethodology.svg}
%     \label{fig:metodologia}
%     \fonte{Autor próprio}
% \end{figure}

% Acima o exemplo do uso de uma imagem vetorial em formato .svg. Para a utilização de imagens vetoriais, o pacote \texttt{svg} deve ser importado e a estrutura \texttt{figure} com o comando \verb|\includesvg[width=1\linewidth]{...}| deve ser utilizado. Para a utilização de imagens em formato .eps, o pacote \texttt{epsfig} deve ser importado e a estrutura \texttt{figure} com o comando \verb|\includegraphics[width=1\linewidth]{...}| deve ser utilizado. Para a utilização de imagens em formato .png ou .jpg, o pacote \texttt{graphicx} deve ser importado e a estrutura \texttt{figure} com o comando \verb|\includegraphics[width=1\linewidth]{...}| deve ser utilizado. Lembrando que o comando \verb|\textbf{\caption{...}}| deve ser usado acima de do comando de inclusão da imagem dentro da estrutura \texttt{figure}.
...
Para a explicação de cálculos utilizando equações como

\begin{equation}\stepcounter{equationCont}\tag{\theequationCont}
    PA = \frac{\sum_{i} n_{ii}}{\sum_{i} t_{i}} + \sum_{n=1}^{\infty} 2^{-n}
\end{equation}

a estrutura \texttt{equation} é utilizada de forma exemplar. O comando \verb|\tag{\theequationCont}| serve para nomear com um número a equação na ordem em que aparecem no texto, sendo \verb|\theequationCont| incrementado com o comando \verb|\stepcounter{equationCont}|.
%% ---

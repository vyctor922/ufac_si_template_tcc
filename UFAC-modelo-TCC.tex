...
% MODIFIED: Formato textual dos títulos com comando \MakeUppercase, adição de quebras de linha para início de parágrafos corretamente, troca de links quebrados, adição ou ajuste de textos de exemplo, posição da legenda e adição de fonte nas figuras e tabelas nos elementos textuais
